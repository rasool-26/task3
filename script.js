...
function insertNewRecord(data) {
  ...
  cell2.innerHTML = data.UniversityName;
...
function onEdit(td) {
  ...
  document.getElementById("UniversityName").value = selectedRow.cells[1].innerHTML;
...
function updateRecord(formData) {
  ...
  selectedRow.cells[1].innerHTML = formData.UniversityName;
